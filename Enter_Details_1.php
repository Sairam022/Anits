...
<center><form method="POST" action="insert_details_1.php">
...
<tr> <td> <?php echo $sub9;?> </td>
	 <td> <select name="sub9" required><option value=""> -- </option><option value="O">'O'-grade</option><option value="A+">'A+'-grade</option><option value="A">'A'-grade</option><option value="B+">'B+'-grade</option><option value="B">'B'-grade</option><option value="C">'C'-grade</option><option value="P">'P'-grade</option><option value="F">'F'-grade</option></select> </td> </tr>
<tr> <td> SGPA </td>
