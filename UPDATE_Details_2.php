...
<form method="POST" action="updated_details_2.php"><center>
...
<tr> <td> SUBJECT </td>
	 <td> <select name="subject"><option value="0">---</option><option value="<?php echo $sub1;?>"><?php echo $sub1;?></option><option value="<?php echo $sub2;?>"><?php echo $sub2;?></option><option value="<?php echo $sub3;?>"><?php echo $sub3;?></option></select> </td> </tr>
<tr> <td> GRADE </td>
	 <td> <select name="grade"><option value="O">'O'-grade</option><option value="A+">'A+'-grade</option><option value="A">'A'-grade</option><option value="B+">'B+'-grade</option><option value="B">'B'-grade</option><option value="C">'C'-grade</option><option value="P">'P'-grade</option><option value="F">'F'-grade</option></select> </td> </tr>
<tr> <td> SGPA </td>
