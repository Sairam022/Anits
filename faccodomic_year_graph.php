...
?>
		<script>
		alert("ACADEMIC YEAR  AND CLASS DETAILS NOT AVAILABLE");
		window.location.href="fStudent_data_to_check_accodomic.html";
		</script>
<?php
...
{
header('Location:faccodomic_year_graph1.php');
}
}
...
{
header('Location:faccodomic_year_graph2.php');
}
}
...
$result=mysql_query("select count(ROLL_NUMBER) as total from 1_1_table where DETAINED='$d1' AND SECTION='$section' AND ACCODOMIC_YEAR='$acc_year' ");
$data=mysql_fetch_assoc($result);
$te1=$data['total'];
