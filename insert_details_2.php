...
if($check!=1)
{
mysql_query("INSERT INTO 4_2_table VALUES('$batch1','$ACCODOMIC_YEAR','$roll_number','$section','$sub1','$sub2','$sub3',$sgpa,$cgpa,'$month_of_pass',$attendence,$num_of_attempts,'$detained')") or die("120120");
?>
		<script>
		alert("DATA INSERTED");
