		...
		<!-- Main -->
			<section id="main" class="wrapper">
				<div class="inner">
					<div class="content">
						<header>
						<CENTER><font face="Baskerville Old Face" size="+3">UPLOAD EXCEL FILE</font>
						</header>

<form method="POST" action="details_upload1.php" enctype="multipart/form-data">
...
<table>
<tr> <td> YEAR </td> 
	 <td> <select required name="year"><option value=""> --SELECT-- </option><option value="1"> 1st YEAR</option><option value="2">2nd YEAR</option><option value="3"> 3rd YEAR </option><option value="4"> 4th YEAR </option></select> </td> </tr>
<tr> <td> SEM </td> 
	 <td> <select required name="sem"><option value=""> --SELECT-- </option><option value="1"> 1st sem</option><option value="2">2nd sem</option></select> </td> </tr>
<tr> <td> Upload Excel File </td>
	...
	<div class="form-group">
	<center>
			<br><button type="submit" name="Submit" class="btn btn-success">Upload</button>
